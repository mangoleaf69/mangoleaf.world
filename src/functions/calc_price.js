...
function estamate_profit(units=100, cost=100, time=10, rate=2000, packaging=500, shiping=100, tax=1.40, profit=2, loss=0.8) {
	...
	let output = {
		...
		total_cost_per_unit,product_development_cost,total_cost,sold_units,actual_cost_per_unit,
		simple_price,
